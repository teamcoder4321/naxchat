import React__default, { createElement, cloneElement, Component, forwardRef } from 'react';
...
function createContextAPI(contextList) {
        ...
        createClass(ContextProvider, [{
            ...
            value: function render() {
                ...
                return Object.values(contextList).reduce(function (Parent, cx) {
                    return createElement(cx.Provider, null, cloneElement(Parent, Object.assign({}, _this2.props)));
                }, this.props.children);
            }
        }]);
    ...
    var withContextProvider = function withContextProvider(Base) {
        var WithContextProvider = function (_React$Component2) {
            ...
            createClass(WithContextProvider, [{
                ...
                value: function render() {
                    ...
                    return createElement(ContextProvider, null, createElement(Base, Object.assign({ ref: forwardedRef }, rest)));
                }
            }]);
        ...
        return forwardRef(function (props, ref) {
            return createElement(WithContextProvider, Object.assign({}, props, { forwardedRef: ref }));
        });
    };
    /**
     * ContextConsumer
    ...
    var getContextConsumer = function getContextConsumer(contextToRenderProps) {
        ...
        return adopt(Object.keys(pickedContextList).reduce(function (acc, cxKey) {
            ...
            acc[cxKey] = createElement(PatialConsumer, null);
            return acc;
        }, {}));
    };
    ...
    var ContextConsumer = function (_React$Component3) {
        ...
        createClass(ContextConsumer, [{
            ...
            value: function render() {
                ...
                return createElement(Consumer, null, this.props.children);
            }
        }]);
    ...
    var withContextConsumer = function withContextConsumer(contextToRenderProps) {
        return function (Base) {
                ...
                createClass(WithContextConsumer, [{
                    ...
                    value: function render() {
                        var _a = this.props,
                            forwardedRef = _a.forwardedRef,
                            rest = __rest(_a, ["forwardedRef"]);
                        return createElement(Consumer, null, function (data) {
                            return createElement(Base, Object.assign({ ref: forwardedRef }, data, rest));
                        });
                    }
                }]);
            ...
            return forwardRef(function (props, ref) {
                return createElement(WithContextConsumer, Object.assign({}, props, { forwardedRef: ref }));
            });
        };
    };
    return {
